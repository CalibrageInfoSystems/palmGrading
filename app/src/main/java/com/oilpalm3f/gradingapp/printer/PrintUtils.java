...
//	}
//
//	public static void printConsignmentData(Resources resources, PrinterInstance mPrinter,
//								 boolean is58mm) {
//		mPrinter.init();
...
//	}
    ...
    public static void printNote(PrinterInstance mPrinter, String dataToPrint,
                                 boolean is58mm) {
        mPrinter.init();
        mPrinter.printText(dataToPrint);
